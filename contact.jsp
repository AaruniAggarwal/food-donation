...
<html>
  <head>
	 ...
	 <link rel="stylesheet" type="text/css" href="<c:url value="/jsp/css/bootstrap.css" />">
	 <link rel="stylesheet" type="text/css" href="<c:url value="/jsp/css/style.css" />">
	 <link rel="stylesheet" type="text/css" href="<c:url value="/jsp/css/login_style.css" />">
	 <link href="./assets/css/blk-design-system.css?v=1.0.0" rel="stylesheet" />
	  <!-- CSS Just for demo purpose, don't include it in your project -->
	  <link href="./assets/demo/demo.css" rel="stylesheet" />
	  
	<link href="https://fonts.googleapis.com/css?family=Lato:400,700,600,500,200,100" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" >
    <div class="container">
      <a class="navbar-brand" href="index.html" style="font-size: 2em;"><b>FEEDING</b> INDIA</a>
...
<div id="about_section" style="background-image:url('<c:url value="/jsp/images/bg_1_about.jpg" />'); height:35vh;">
                    <!-- <div id="label_right"> -->
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="email" class="form-control" id="nombre" name="Email" placeholder="Enter your email id" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <textarea class="form-control" placeholder="How can we help? " required></textarea>
                                    </div>
                                </div>
